...
Plot shows the normalized ratios (not blank corrected) of the TIRI-F and Ceylon samples from the test. Error bars are the maximum of the internal and external errors. The blue line is the 2018 average for TIRI-F on CFAMS (0.0022) and the lighter lines are the std dev of 2018 measurements of TIRI-F on CFAMS. The red line and lighter red lines are the mean and SD of Ceylon on CFAMS.
...
Plot shows the normalized ratios (not blank corrected) of the C-1 and Ceylon samples from the test. Control treatment is fresh C-1 and Ceylon pressed for the wheel. Error bars are the maximum of the internal and external errors. The blue line is the 2018 average for C-1 on USAMS (0.0009) and the lighter lines are the std dev of 2018 measurements. The red line and lighter red lines are the mean and SD of Ceylon on USAMS.
