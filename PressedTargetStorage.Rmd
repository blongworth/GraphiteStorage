...
ggplot(data, aes(treatment, norm_ratio, color = type)) +
  geom_hline(yintercept = 0.0012, color = '#89C3C4') +
  geom_hline(yintercept = 0.0032, color = '#89C3C4') +
  geom_hline(yintercept = 0.0022, color = '#00BFC4') +
  geom_hline(yintercept = 0.0003, color = '#F8BEBA') +
  geom_hline(yintercept = 0.0015, color = '#F8BEBA') +
  geom_hline(yintercept = 0.0009, color = '#F8766D') +
